...
life=data.frame(
X1=c(2.5,173,119,10,502,4,14.4,2,40,6.6,21.4,2.8,2.5,6,3.5,62.2,10.8,21.6,2,3.4,5.1,2.4,1.7,1.1,
12.8,1.2,3.5,39.7,62.4,2.4,34.7,28.4,0.9,30.6,5.8,6.1,2.7,4.7,128,35,2,8.5,2,2,4.3,244.8,4,5.1,32,1.4),
...
pre<-predict(glm.sol,data.frame(X1=5,X2=2,X3=1))  #难道这是做预测的意思？
p<-exp(pre)/(1+exp(pre))
